...
let turbo = document.querySelector('.turbo-one')
let px
...
window.addEventListener('scroll', function () {
	...
	turbo.style.transform = `translate(${px}px,0)`
})
let tvetical = document.querySelector('.tvetical')
tvetical.addEventListener('click', function () {
	tvetical.classList.add('_active')
})
let turbob = document.querySelector('.turbob')
turbob.addEventListener('click', function () {
	turbob.classList.add('_active')
})

// -------------------------timer---------------------
let endDate = new Date("Mar 12, 2022 18:00:00").getTime();
let timer = setInterval(function () {
	...
	if (t >= 0) {
		...
		if (secs.toString().length == 1) {
			document.querySelector("._seconds").innerHTML = ("0" + secs)
		} else {
			document.querySelector("._seconds").innerHTML = secs
		}
